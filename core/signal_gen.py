...
_RULES: list[dict] = [
    {
        ...
        "keywords": [
            ...
            "federal reserve", "interest rate", "fomc", "powell",
            "fed raises", "fed hikes", "monetary policy",
        ],
    ...
    },
    {
        ...
        "keywords": [
            ...
            "federal reserve", "interest rate", "fomc", "powell",
            "fed cuts", "lower rates", "accommodative", "monetary policy",
        ],
    ...
    },
    {
        ...
        "keywords": [
            ...
            "jobs", "unemployment", "payroll", "labor market",
            "job gains", "job losses", "jobless", "layoffs", "job cuts",
        ],
    ...
    },
    {
        ...
        "keywords": [
            ...
            "tariff", "tariffs", "price pressures", "pce",
            "prices rise", "price hike",
        ],
    ...
    },
    {
        ...
        "keywords": [
            ...
            "gdp", "bear market", "market crash", "recession fears",
            "economic contraction", "growth slows",
        ],
        "actions": {"positive": None, "negative": "sell", "neutral": None},
        "confidence_mult": 0.85,
        "ticker": "SPY",
    ...
    },
    {
        ...
        "keywords": [
            ...
            "war", "conflict", "troops", "missile", "nato",
            "ukraine", "ceasefire", "military",
        ],
        "actions": {"positive": None, "negative": "sell", "neutral": None},
        "confidence_mult": 0.85,
        "ticker": "SPY",
    ...
    },
    {
        ...
        "keywords": [
            ...
            "stocks", "s&p 500", "wall street", "dow jones", "nasdaq",
            "markets rise", "market gains", "stock market",
        ],
        "actions": {"positive": "buy", "negative": None, "neutral": None},
    ...
    },
    {
        ...
        "keywords": [
            ...
            "oil", "crude", "middle east", "iran", "energy",
        ],
        "actions": {"positive": "buy", "negative": "buy", "neutral": None},
        "confidence_mult": 0.80,
        "ticker": "BCO_USD",
